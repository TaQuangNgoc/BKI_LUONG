...
REM InnovaHxReg /U /P /productnamespace:MS.VSIPCC.v90 /producthxt:_DEFAULT /namespace:newprojecttest1 /hxt:_DEFAULT

REM Remove the plug in to the Visual Studio.NET 2005 help system
REM InnovaHxReg /U /P /productnamespace:MS.VSIPCC.v80 /producthxt:_DEFAULT /namespace:newprojecttest1 /hxt:_DEFAULT

REM Remove the plug in to the Visual Studio.NET 2003 help system
REM InnovaHxReg /U /P /productnamespace:MS.VSCC.2003 /producthxt:_DEFAULT /namespace:newprojecttest1 /hxt:_DEFAULT

REM Remove the plug in to the Visual Studio.NET 2002 help system
REM InnovaHxReg /U /P /productnamespace:MS.VSCC /producthxt:_DEFAULT /namespace:newprojecttest1 /hxt:_DEFAULT

REM Un-Register the help file (title in Help 2.0 terminology)
InnovaHxReg /U /T /namespace:newprojecttest1 /id:Default /langid:1033 /helpfile:"Default.hxs"

REM Un-Register the Namespace
InnovaHxReg /U /N /Namespace:newprojecttest1 /Description:"" /Collection:COL_Default.hxc
