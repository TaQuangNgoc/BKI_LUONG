...
namespace MaterialSkin.Controls
{
    public class MaterialCheckBox : CheckBox, IMaterialControl
    {
        ...
        public Color Color
        {
            ...
            set
            {
                m_color = Color.FromArgb(0, 112, 23);
            }
        }
        ...
        public MaterialCheckBox(Color color)
        {
            animationManager = new AnimationManager
            {
                AnimationType = AnimationType.EaseInOut,
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            SolidBrush brush;
            Pen pen;
            if (m_color.B != 0 || m_color.R != 0 || m_color.G != 0)
            {
            ...
            {
                brush = new SolidBrush(Color.FromArgb(colorAlpha, Enabled ? SkinManager.ColorScheme.AccentColor : SkinManager.GetCheckBoxOffDisabledColor()));
                pen = new Pen(brush.Color);
            }
