    ...
    public partial class CHAM_CONG_THEO_SAN_PHAM : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void tao_file_mau(string ip_file_name)
        {
            ...
            if (targetPath != "")
            {
                ...
                v_ds.Tables[0].Columns.Add("NGAY_CHAM_CONG");
                v_ds.Tables[0].Columns.Add("MA_SAN_PHAM");
                v_ds.Tables[0].Columns.Add("MA_NHAN_VIEN");
                v_ds.Tables[0].Columns.Add("SO_LUONG");
                v_ds.Tables[0].Columns.Add("CHAT_LUONG");   
        ...
        {  
            ...
            v_us.FillDatasetWithQuery(m_ds_nhan_vien, "SELECT * FROM DM_NHAN_VIEN WHERE ID IN ( SELECT ID_NHAN_VIEN FROM GD_NHAN_VIEN_HINH_THUC_TINH_LUONG WHERE ID_HINH_THUC_TINH_LUONG=3 AND CO_YN='Y')");
        }
        ...
        private decimal get_so_luong_cham_cong()
        {
            ...
            v_ds.Tables.Add(new DataTable());
            US_DUNG_CHUNG v_us = new US_DUNG_CHUNG();
            v_us.FillDatasetChamCongTheoSanPham(v_ds, m_dat_chon_thang.DateTime.Month.ToString(), m_dat_chon_thang.DateTime.Year.ToString());
        ...
        private void xoa_du_lieu_cham_cong_cu(decimal ip_dc_id_nv)
        {
            ...
            v_us.xoaDuLieuChamCongSanPham(ip_dc_id_nv, m_dat_chon_thang.DateTime.Month.ToString(), m_dat_chon_thang.DateTime.Year.ToString());
        }
        ...
        private void m_cmd_mo_file_mau_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    tao_file_mau("Chấm công theo sản phẩm tháng " + m_dat_chon_thang.DateTime.Month.ToString() + "-" + m_dat_chon_thang.DateTime.Year.ToString() + ".xls");
                }
            }
            catch (Exception v_e)
            {
